...
Solving equation (9) for r gives $r = -\gamma {\pm}\sqrt{\gamma^2-\omega^2}$, which yields three distinct cases depending on the relationship between $\gamma$ and $\omega$.

- Underdamped ($\gamma < \omega$): where $r = -\gamma \pm i\omega_{d}$ and $\omega_{d} = \sqrt(\omega^2 - \gamma^2)$. The solution to equation (9) becomes:

$$\boxed{x(t) = e^{-\gamma{t}}(A\cos(\omega_{d}{t}) + B\sin(\omega_{d}{t}))}$$

- Overdamped ($\gamma > \omega$): where $r = -\gamma \pm \sqrt{\gamma^2 - \omega^2}$ The solution to equation (9) becomes: 

$$\boxed{x(t) = Ce^{r_{1}t} + De^{r_{2}t}}$$

- Critically Damped ($\gamma = \omega$): where $r = -\gamma$. The solution to equation (9) becomes:

$$\boxed{x(t) = (A + Bt)e^{-\gamma{t}}}$$
